export const ru = {
  ...
  tasks: {
    ...
    priority: 'Приоритет',
    dueDate: 'Срок',
    reminderDate: 'Напоминание',
    assignees: 'Исполнители',
    selectAssignees: 'Выберите исполнителей',
    relatedDoc: 'Связанный документ',
    notes: 'Заметки',
    complete: 'Выполнить',
    markInProgress: 'В работу',
    createdBy: 'Создал',
    totalTasks: 'Всего задач',
    overdueAlert: 'Просроченные задачи',
    upcomingAlert: 'Ближайшие дедлайны',
    items: 'записей',
    priorities: {
      LOW: 'Низкий',
      MEDIUM: 'Средний',
  ...
  corrections: {
    ...
    reportedBy: 'Сообщил',
    resolution: 'Решение',
    detail: 'Детали исправления',
    startFix: 'Начать исправление',
    resolve: 'Решить',
    verify: 'Подтвердить',
    reopen: 'Переоткрыть',
    comments: 'Комментарии',
    addComment: 'Добавить комментарий...',
    enterResolution: 'Введите описание решения:',
    total: 'Всего ошибок',
    errorTypes: {
  ...
  progress: {
    ...
    documentsProgress: 'Документы',
    workProgress: 'Виды работ',
    taskProgress: 'Задачи',
    correctionsSummary: 'Сводка по исправлениям',
    milestones: 'Этапы',
  ...
  team: {
    ...
    addExisting: 'Добавить пользователя',
